...
export default async function InicioPage() {
  ...
  // Matching trades (trades where we have the sticker they want)
  const matchingTrades = (trades ?? [])
    .filter((t: { wanting_sticker_id: string; offering_sticker_id: string }) => ownedSet.has(t.wanting_sticker_id))
    .slice(0, 4)
